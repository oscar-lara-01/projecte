    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/hp_m209d_1.png" alt="HP LaserJet M209d Frontal">
                <img src="imgp/hp_m209d_2.png" alt="HP LaserJet M209d Superior">
                <img src="imgp/hp_m209d_3.png" alt="HP LaserJet M209d Conectividad">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Tecnología:</span> Láser Monocromo</li>
                <li><span>Velocidad:</span> Hasta 29 ppm</li>
                <li><span>Dúplex:</span> Automático (Doble cara)</li>
                <li><span>Conectividad:</span> Wi-Fi dual, Bluetooth, USB</li>
                <li><span>Bandeja:</span> 150 hojas</li>
                <li><span>Tóner:</span> HP 135A / 135X Negro</li>
            </ul>
