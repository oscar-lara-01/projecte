...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'LG UltraGear 27G610A-B 27"',
        'precio' => 449.00,
        'imagen' => 'imgp/Ultragear.png'
    ];
...
<head>
<meta charset="UTF-8">
<title>LG UltraGear 27GQ850-B</title>
</head>
<body>

<h1>LG UltraGear 27GQ850-B 27"</h1>

<div class="container">
<div class="producto-imagen">
<button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
<div class="slider-wrapper" id="slider">
<img src="imgp/Ultragear.png">
...
<li><span>Panel:</span> Nano IPS</li>
<li><span>Frecuencia:</span> 240Hz</li>
<li><span>Tiempo respuesta:</span> 1ms</li>
<li><span>Compatibilidad:</span> G-Sync / FreeSync</li>
</ul>
