...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'MSI Katana 17',
        'precio' => 1549.00,
        'imagen' => 'imgp/msikatana17.png'
    ];
    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/msikatana17.png" alt="Vista Principal">
                <img src="imgp/msikatana17l.png" alt="Vista Lateral">
                <img src="imgp/msikatana17t.png" alt="Detalle Teclado">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Procesador:</span> i9-14900HX</li>
            ...
            <div class="precio-tag">
                <span class="monto">1,549.00€</span>
