    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/canon_gx7050_1.png" alt="Canon MAXIFY GX7050 Frontal">
                <img src="imgp/canon_gx7050_2.png" alt="Canon MAXIFY GX7050 ADF">
                <img src="imgp/canon_gx7050_3.png" alt="Canon MAXIFY GX7050 Tanques">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Tipo:</span> MegaTank 4 en 1 (Fax incluido)</li>
                <li><span>Velocidad:</span> 24 ipm (B/N) / 15.5 ipm (Color)</li>
                <li><span>Escaneado:</span> ADF Dúplex de un paso</li>
                <li><span>Capacidad:</span> 600 hojas (2 cassetes + trasera)</li>
                <li><span>Pantalla:</span> LCD Táctil 6.9 cm</li>
                <li><span>Tinta:</span> Botellas GI-56 (Pigmentada)</li>
            </ul>
