    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/hp2630_1.png" alt="HP DeskJet 2630 Frontal">
                <img src="imgp/hp2630_2.png" alt="HP DeskJet 2630 Perfil">
                <img src="imgp/hp2630_3.png" alt="HP DeskJet 2630 Escáner">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Tipo:</span> Inyección de tinta térmica</li>
                <li><span>Funciones:</span> Imprime, Copia, Escanea</li>
                <li><span>Velocidad:</span> 7.5 ppm (B/N) / 5.5 ppm (Color)</li>
                <li><span>Conectividad:</span> Wi-Fi, USB 2.0 High Speed</li>
                <li><span>Móvil:</span> HP Smart App / AirPrint</li>
                <li><span>Cartuchos:</span> HP 304 Negro / Tricolor</li>
            </ul>
