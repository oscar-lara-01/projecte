...
<body>
    ...
    <h1>Logitech G522 LightSpeed</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/LOGG522.png" alt="Vista Principal">
                <img src="imgp/LOGG522-2.png" alt="Vista Lateral">
                <img src="imgp/LOGG522-2.png" alt="Detalle Teclado">
            </div>
...
<li><span>Tipo:</span> Auriculares Gaming inalámbricos</li>
<li><span>Conectividad: </span> LIGHTSPEED + Bluetooth</li>
<li><span>Sonido:</span> DTS Headphone:X 2.0</li>
<li><span>Micrófono:</span> Extraíble</li>
<li><span>Batería:</span> Hasta 30h</li>
<li><span>Compatibilidad:</span> PC / PS5 / PS4</li>
</ul>

<div class="precio-tag">
<span class="monto">139,00€</span>
