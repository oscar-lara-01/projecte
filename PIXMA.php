...
// 2. Lógica para añadir al carrito (Adaptado a Canon PIXMA TS3750i)
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Canon PIXMA TS3750i',
        'precio' => 49.99,
        'imagen' => 'imgp/canon_ts3750i.png'
    ];
...
<head>
    ...
    <title>Canon PIXMA TS3750i - Detalles</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .boton-accion {
            ...
            padding: 18px 25px;
            background-color: #6c63ff; /* Púrpura original */
            color: #fff;
        ...
        /* BOTÓN VOLVER (FORMA DE IMPRESORA CON COLORES ORIGINALES) */
        .boton-volver {
...
<body>
    ...
    <h1>Canon PIXMA TS3750i</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/PIXMA.png" alt="Vista Principal">
                <img src="imgp/PIXMAe.png" alt="Vista Escáner">
                <img src="imgp/PIXMAp.png" alt="Detalle Panel">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Funciones:</span> WiFi, Impresión, Copia, Escaneo</li>
                <li><span>Velocidad:</span> 7.7 ipm (B/N) / 4.0 ipm (Color)</li>
                <li><span>Resolución:</span> 4800 x 1200 ppp</li>
                <li><span>Pantalla:</span> LCD 1.5" Monocromo</li>
                <li><span>Cartuchos:</span> FINE (Negro y Color)</li>
                <li><span>Conexión:</span> App Canon PRINT / AirPrint</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">49,99€</span>
