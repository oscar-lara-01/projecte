...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Samsung S27D302GAU 27"',
        'precio' => 149.00,
        'imagen' => 'imgp/Samsung27.png'
    ];
...
<head>
<meta charset="UTF-8">
<title>Samsung S27D302GAU 27"</title>
</head>
<body>

<h1>Samsung S27D302GAU 27"</h1>

<div class="container">
<div class="producto-imagen">
<button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
<div class="slider-wrapper" id="slider">
<img src="imgp/Samsung27.png">
...
<li><span>Frecuencia:</span> 100Hz</li>
<li><span>Tiempo respuesta:</span> 5ms</li>
<li><span>Tecnología:</span> Eye Saver Mode</li>
</ul>

<div class="precio-tag">
<span class="monto">149,00€</span>
