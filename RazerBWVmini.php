...
<body>
    ...
    <h1>Razer BlackWidow V3 Mini</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/RazerBWV3mini.png" alt="Vista Principal">
                <img src="imgp/RazerBWV3mini-2.png" alt="Vista Lateral">
                <img src="imgp/RazerBWV3mini-2.png" alt="Detalle Teclado">
            </div>
...
<li><span>Tipo:</span> Teclado mecánico 65%</li>
<li><span>Switches:</span> Razer Green / Yellow</li>
<li><span>Conectividad: </span> HyperSpeed Wireless + Bluetooth</li>
<li><span>Iluminación:</span> Razer Chroma RGB</li>
<li><span>Batería:</span> Hasta 200h</li>
<li><span>Reposamuñecas:</span> No</li>
</ul>
