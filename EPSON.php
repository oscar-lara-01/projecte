...
// 2. Lógica para añadir al carrito (Adaptado a Epson EcoTank L8100)
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Epson EcoTank L8100',
        'precio' => 449.00,
        'imagen' => 'imgp/epson_l8100.png'
    ];
...
<head>
    ...
    <title>Epson EcoTank L8100 - Detalles</title>
...
<body>
    ...
    <h1>Epson EcoTank L8100</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/epson_l8100_1.png" alt="Epson L8100 Frontal">
                <img src="imgp/epson_l8100_2.png" alt="Epson L8100 Depósitos">
                <img src="imgp/epson_l8100_3.png" alt="Epson L8100 Bandeja">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Tecnología:</span> Inyección de tinta (6 colores)</li>
                <li><span>Resolución:</span> 5760 x 1440 dpi</li>
                <li><span>Sistema:</span> EcoTank (Tanques recargables)</li>
                <li><span>Tamaño máx:</span> A4 / Carta / Fotográfico</li>
                <li><span>Velocidad:</span> 22 ppm (B/N) / 22 ppm (Color)</li>
                <li><span>Conectividad:</span> Wi-Fi, Wi-Fi Direct, USB</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">449,00€</span>
