...
// 2. Lógica para añadir al carrito (Adaptado a Brother MFC-L3760CDW)
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Brother MFC-L3760CDW',
        'precio' => 419.00,
        'imagen' => 'imgp/brother_mfc_l3760cdw.png'
    ];
...
<head>
    ...
    <title>Brother MFC-L3760CDW - Detalles</title>

    <style>
        /* BASE ORIGINAL MANTENIDA */
...
<body>
    ...
    <h1>Brother MFC-L3760CDW</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/brothermfcf.png" alt="Brother Frontal">
                <img src="imgp/brothermfcp.png" alt="Brother Panel">
                <img src="imgp/brothermfct.png" alt="Brother Tinta">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Funciones:</span> Impresión, copia, escaneo, fax</li>
                <li><span>Velocidad:</span> 26 ppm (Color/Monocromo)</li>
                <li><span>Resolucion:</span> Impresión Automática</li>
                <li><span>Pantalla:</span> Táctil color 8.8 cm</li>
                <li><span>Tinta:</span> TN248</li>
                <li><span>Conexion:</span> Wi-Fi, Wi-Fi Direct, Ethernet (Gigabit), USB 2.0 y compatibilidad con aplicaciones móviles</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">419,00€</span>
