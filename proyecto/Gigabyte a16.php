...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Gigabyte Gaming a16',
        'precio' => 1049.00,
        'imagen' => 'imgp/gigabytea16.png'
    ];
...
<head>
    ...
    <title>Gigabyte Gaming a16 - Detalles</title>
...
<body>
    ...
    <h1>Gigabyte Gaming a16</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/gigabytea16.png" alt="Vista Principal">
                <img src="imgp/gigabytea16l.png" alt="Vista Lateral">
                <img src="imgp/gigabytea16t.png" alt="Detalle Teclado">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Procesador:</span> i7-13620H</li>
                <li><span>Memoria:</span> 16GB DDR5</li>
                <li><span>Gráficos:</span> RTX 5050</li>
                <li><span>SSD:</span> 1000GB NVMe</li>
                <li><span>Pantalla:</span> 165Hz</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">1049,00€</span>
