...
// 2. Lógica para añadir al carrito (Adaptado a HP DeskJet 2630)
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'HP DeskJet 2630',
        'precio' => 55.00,
        'imagen' => 'imgp/hp_deskjet_2630.png'
    ];
...
<head>
    ...
    <title>HP DeskJet 2630 - Detalles</title>
...
<body>
    ...
    <h1>HP DeskJet 2630</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/hpdeskjetf.png" alt="HP DeskJet Frontal">
                <img src="imgp/hpdeskjetp.png" alt="HP DeskJet panel">
                <img src="imgp/hpdeskjett.png" alt="HP DeskJet Tinta">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Funciones:</span> Impresión, copia, escaneo</li>
                <li><span>Velocidad:</span>  7.5 ppm (B/N) / 5.5 ppm (Color)</li>
                <li><span>Resolucion:</span> 4.800 x 1.200 ppp </li>
                <li><span>Pantalla:</span> Pantalla LCD de iconos con botones físicos (sin panel táctil)</li>
                <li><span>Tinta:</span> HP 304</li>
                <li><span>Conexion:</span> USB 2.0 de alta velocidad y Wi-F</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">55,00€</span>
