...
<head>
    ...
    <title>Lenovo Legion 5 - Detalles</title>
    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/lenovolegion5.png" alt="Vista Principal">
                <img src="imgp/lenovolegion5l.png" alt="Vista Lateral">
                <img src="imgp/lenovolegion5t.png" alt="Detalle Teclado">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Procesador:</span> i7-13650HX</li>
                <li><span>Memoria:</span> 32GB DDR5</li>
                <li><span>Gráficos:</span> RTX 5060</li>
                <li><span>SSD:</span> 1000GB NVMe</li>
                <li><span>Pantalla:</span> 165Hz</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">1399,99€</span>
