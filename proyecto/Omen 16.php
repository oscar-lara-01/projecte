...
<head>
    ...
    <title>HP Omen 16 - Detalles</title>
    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/hpomen16.png" alt="Vista Principal">
                <img src="imgp/hpomen16l.png" alt="Vista Lateral">
                <img src="imgp/hpomen16t.png" alt="Detalle Teclado">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Procesador:</span> AMD Ryzen AI 7 350</li>
                <li><span>Memoria:</span> 32GB DDR5</li>
                <li><span>Gráficos:</span> RTX 5070</li>
                <li><span>SSD:</span> 1000GB NVMe</li>
                <li><span>Pantalla:</span> 240Hz</li>
            </ul>

            <div class="precio-tag">
                <span class="monto">1799,00€</span>
