...
// 2. Lógica para añadir al carrito (Adaptado a HP LaserJet M209dwe/d)
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'HP LaserJet M209d',
        'precio' => 169.00,
        'imagen' => 'imgp/hp_laserjet_m209d.png'
    ];
...
<head>
    ...
    <title>HP LaserJet M209d - Detalles</title>
...
<body>
    ...
    <h1>HP LaserJet M209d</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/hplaserjetf.png" alt="HP LaserJet M209d Frontal">
                <img src="imgp/hplaserjetp.png" alt="HP LaserJet M209d Panel">
                <img src="imgp/hplaserjett.png" alt="HP LaserJet M209d Tinta">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Funciones:</span> Láser Monocromo</li>
                <li><span>Velocidad:</span> Hasta 29 ppm</li>
                <li><span>Resolucion:</span> 600x600 ppp</li>
                <li><span>Pantalla:</span> Sin pantalla, botones con indicadores LED</li>
                <li><span>Tinta:</span> HP 139A</li>
                <li><span>Conexion:</span> USB 2.0 de alta velocidad, Wi-Fi de doble banda y Bluetooth LE</li>
            </ul>
