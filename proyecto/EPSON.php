    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/epsonl8100f.png" alt="Epson L8100 Frontal">
                <img src="imgp/epsonl8100p.png" alt="Epson L8100 panel">
                <img src="imgp/epsonl8100t.png" alt="Epson L8100 tinta">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Funciones:</span> Impresión de fotografías y documentos</li>
                <li><span>Velocidad:</span> 32 ppm (negro/color)</li>
                <li><span>Resolucion:</span> 5.760 x 1.440 ppp </li>
                <li><span>Pantalla:</span> LCD a color de 6,1 cm </li>
                <li><span>Tinta:</span> Epson 673</li>
                <li><span>Conexion:</span> Wi-Fi, Wi-Fi Direct, USB</li>
            </ul>
