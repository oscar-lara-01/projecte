...
<style>
    ...
    .cesta-icono {
        background: #6c63ff; padding: 15px; border-radius: 50%;
        box-shadow: 0 5px 15px rgba(108,99,255,0.4);
        display: block; font-size: 20px;
    }
</style>

<a href="carrito.php" class="boton-cesta">
    <span class="cesta-icono">🛒</span>
    <span style="font-size:10px; text-transform:uppercase;">Mi Cesta</span>
</a>
