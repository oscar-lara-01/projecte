...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Acer Nitro KG241YX3BIP 23.8"',
        'precio' => 169.00,
        'imagen' => 'imgp/Acer23.8.png'
    ];
...
<head>
<meta charset="UTF-8">
<title>Acer Nitro KG241YX3BIP 23.8</title>
</head>
<body>

<h1>Acer Nitro KG241YX3BIP 23.8</h1>

<div class="container">
<div class="producto-imagen">
<button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
<div class="slider-wrapper" id="slider">
<img src="imgp/Acer23.8.png">
