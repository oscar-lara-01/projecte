...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'MSI MAG 276CXF 27"',
        'precio' => 279.00,
        'imagen' => 'imgp/MSImag.png'
    ];
...
<head>
<meta charset="UTF-8">
<title>MSI – MSI MAG 276CXF</title>
</head>
<body>

<h1>MSI – MSI MAG 276CXF</h1>

<div class="container">
<div class="producto-imagen">
<button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
<div class="slider-wrapper" id="slider">
<img src="imgp/MSImag.png">
...
<li><span>Resolución:</span> 1920x1080 (Full HD)</li>
<li><span>Panel:</span> VA Curvo 1500R</li>
