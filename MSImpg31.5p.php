...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'MSI MPG 321URX QD-OLED 31.5',
        'precio' => 1399.00,
        'imagen' => 'imgp/MSImpg.png'
    ];
...
<head>
    ...
    <title>LG UltraGear 27GQ850-B 27 - Detalles</title>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'LG UltraGear 27GQ850-B 27"',
        'precio' => 449.00,
        'imagen' => 'imgm/ultragear1.png'
    ];
...
<head>
<meta charset="UTF-8">
<title>MSI MPG 321URX QD-OLED 31.5"</title>
</head>
<body>

<h1>MSI MPG 321URX QD-OLED 31.5"</h1>

<div class="container">
<div class="producto-imagen">
<button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
<div class="slider-wrapper" id="slider">
<img src="imgp/MSImpg.png">
<img src="imgm/ultragear2.png">
<img src="imgm/ultragear3.png">
</div>
...
<li><span>Tamaño:</span> 31.5"</li>
<li><span>Resolución:</span> 3840x2160 (4K UHD)</li>
<li><span>Panel:</span> QD-OLED</li>
<li><span>Frecuencia:</span> 240Hz</li>
<li><span>Tiempo respuesta:</span> 0.03ms</li>
<li><span>Certificación:</span> HDR True Black 400</li>
</ul>

<div class="precio-tag">
<span class="monto">1399,00€</span>
...
<a href="monitors.php" class="boton-volver">
