    ...
    <div class="container">
        <div class="producto-imagen">
            ...
            <div class="slider-wrapper" id="slider">
                <img src="imgp/brother_mfc_1.png" alt="Brother Frontal">
                <img src="imgp/brother_mfc_2.png" alt="Brother Alimentador">
                <img src="imgp/brother_mfc_3.png" alt="Brother Pantalla Táctil">
            </div>
        ...
        <div class="info-container">
            ...
            <ul class="especificaciones">
                <li><span>Tecnología:</span> LED Color Multifunción</li>
                <li><span>Velocidad:</span> 26 ppm (Color/Monocromo)</li>
                <li><span>Duplex:</span> Impresión Automática</li>
                <li><span>Pantalla:</span> Táctil color 8.8 cm</li>
                <li><span>Conectividad:</span> WiFi 5GHz, Gigabit, USB</li>
                <li><span>Memoria:</span> 512MB RAM interna</li>
            </ul>
