...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_to_cart'])) {
    $producto = [
        'nombre' => 'Asrock Phantom Gaming 27"',
        'precio' => 299.00,
        'imagen' => 'imgp/Asrock27.png'
    ];
...
<img src="imgp/Asrock27.png">
<img src="imgm/Asrock27-2.png">
...
<li><span>Tamaño:</span> 27"</li>
<li><span>Resolución:</span> 2560x1440 (QHD)</li>
<li><span>Panel:</span> IPS</li>
<li><span>Frecuencia:</span> 165Hz</li>
<li><span>Tiempo respuesta:</span> 1ms</li>
<li><span>Compatibilidad:</span> FreeSync Premium</li>
</ul>

<div class="precio-tag">
<span class="monto">299,00€</span>
