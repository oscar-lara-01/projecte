...
<body>
    ...
    <h1>Corsair Core K70</h1>

    <div class="container">
        <div class="producto-imagen">
            <button class="flecha flecha-izq" onclick="moveSlide(-1)">&#10094;</button>
            <div class="slider-wrapper" id="slider">
                <img src="imgp/Corsairk70.png" alt="Vista Principal">
                <img src="imgp/Corsairk70-2.png" alt="Vista Lateral">
                <img src="imgp/Corsairk70-3.png" alt="Detalle Teclado">
            </div>
...
<li><span>Tipo:</span> Teclado mecánico</li>
<li><span>Switches:</span> MLX Red</li>
<li><span>Formato:</span> Full Size</li>
<li><span>Iluminación:</span> RGB</li>
<li><span>Material:</span> Aluminio</li>
<li><span>Conexión:</span> USB</li>
</ul>

<div class="precio-tag">
<span class="monto">129,00€</span>
